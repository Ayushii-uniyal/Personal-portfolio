    ...
    <section className = "about container section" id = "about">
        ...
        <div className = "about__container grid">
            <div className = "about__info">
                <p className = "about__desc">Hi! I'm Ayushi Uniyal - a CSE undergrad who loves crafting web apps and diving into the world of machien learning. Be it front-end magic with React or smart predictions using Scikit-learn, I enjoy turning ideas into interactive experiences</p>
